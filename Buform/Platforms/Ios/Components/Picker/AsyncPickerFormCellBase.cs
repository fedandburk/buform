...
public abstract class AsyncPickerFormCellBase<TAsyncPickerItem> : PickerFormCellBase<TAsyncPickerItem> where TAsyncPickerItem : class, IAsyncPickerFormItem
{
    protected virtual PickerPresenterBase<TAsyncPickerItem>? PickerPresenter
    {
        get;
        private set;
    }
    ...
    protected virtual UIViewController CreateViewController(TAsyncPickerItem item)
    {
    ...
    protected virtual void UpdateInputType()
    {
        ...
        PickerPresenter = Item.InputType switch
        {
            PickerInputType.Default
                => new DefaultPickerPresenter<TAsyncPickerItem>(CreateViewController),
            PickerInputType.Dialog
                => new DialogPickerPresenter<TAsyncPickerItem>(CreateViewController),
